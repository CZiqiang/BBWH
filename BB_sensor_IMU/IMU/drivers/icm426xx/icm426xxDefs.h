/********************************************************************************
  * @file    IMU/drivers/icm426xx/icm426xxDefs.h
...
typedef enum
{
	...
	ICM426XX_GYRO_CONFIG0_FS_DONTOUCH			 = (0xEE)//donnt need change the value
#endif
...
typedef enum
{
	...
	ICM426XX_GYRO_CONFIG0_ODR_DONTOUCH	= (0xEE)//donnt need change the value
...
typedef enum
{
	...
	ICM426XX_ACCEL_CONFIG0_FS_DONTOUCH			 = (0xEE)//donnt need change the value
#endif
...
typedef enum
{
	...
	ICM426XX_ACCEL_CONFIG0_ODR_DONTOUCH			 = (0xEE)//donnt need change the value
